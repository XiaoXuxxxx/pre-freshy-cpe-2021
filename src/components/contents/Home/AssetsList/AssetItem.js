...
export default function AssetItem({ image, value, unit, sideButton }) {
  return (
    <div className="flex flex-row items-center justify-between p-3 bg-white bg-opacity-40 space-x-4 filter backdrop-blur-3xl rounded-xl">
      <div className="flex items-center justify-center">
        ...
        <div className="flex flex-row ml-4 items-end">
          <div className="font-extrabold text-xl text-indigo-900">{value}</div>
